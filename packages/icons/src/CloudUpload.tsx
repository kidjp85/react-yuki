...
export default withIcon('CloudUpload', ({ color, strokeWidth }) => (
  <g fill={color} stroke={color} strokeLinecap="square" strokeWidth={strokeWidth}>
    <line fill="none" stroke={color} strokeLinecap="butt" x1="24" x2="24" y1="36" y2="20" />
    <polyline fill="none" points="18,26 24,20 30,26 " stroke={color} />
    <path
