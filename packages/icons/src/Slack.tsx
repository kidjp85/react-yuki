...
export default withIcon('Slack', ({ color }) => (
  <>
    ...
    <path d="M34.267,18.134V6.4a4.4,4.4,0,1,0-8.8,0V18.133a4.4,4.4,0,1,0,8.8,0" fill={color} />
    <path d="M29.866,46a4.4,4.4,0,1,0,0-8.8h-4.4v4.4a4.4,4.4,0,0,0,4.4,4.4" />
    <path d="M29.866,34.267H41.6a4.4,4.4,0,1,0,0-8.8H29.866a4.4,4.4,0,0,0,0,8.8h0" fill={color} />
