...
export default withIcon('CloudDownload', ({ strokeWidth }) => (
  <g fill="currentColor" stroke="currentColor" strokeLinecap="square" strokeWidth={strokeWidth}>
    <line fill="none" stroke="currentColor" strokeLinecap="butt" x1="24" x2="24" y1="20" y2="36" />
    <polyline fill="none" points="30,30 24,36 18,30 " stroke="currentColor" />
    <path
